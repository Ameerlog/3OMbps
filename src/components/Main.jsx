...
//            Technology at your doorstep at the speed of <span className="text-[#9B5DE0]">30Mb Per Second</span>
...
const Main = () => {
  return (
    ...
    >
      ...
      <div className="relative w-full px-0 mt-4 sm:mt-8 md:mt-10 z-10">
        <header className="w-full text-center px-4 mb-8 sm:mb-10 md:mb-16">
          <h1 className="mt-6 sm:mt-4 text-3xl sm:text-xl md:text-3xl lg:text-4xl font-bold text-slate-900 tracking-tight leading-tight px-2">
            Technology at your doorstep at the speed of{" "}
            <span className="text-[#9B5DE0] font-bold">
              30Mb Per Second
            </span>
          </h1>

          <span className="inline-flex items-center gap-1 rounded-full bg-slate-900 text-slate-50 px-4 py-1 text-[10px] sm:text-[11px] font-medium tracking-[0.18em] mt-3">
            Introducing 30Mbps
            <span className="h-1.5 w-1.5 rounded-full bg-emerald-400" />
          </span>
        ...
        <div className="mt-4 sm:mt-6 flex justify-center px-4">
          ...
          >
            <span className="absolute right-0 h-full w-0 bg-[#9B5DE0] transition-all duration-[400ms] ease-in-out group-hover:left-0 group-hover:right-auto group-hover:w-full" />
            <span className="relative z-20 text-center py-4 px-8 sm:py-5 sm:px-12 md:py-6 md:px-16 text-white text-base sm:text-lg md:text-2xl font-bold tracking-[0.15em] sm:tracking-[0.2em] md:tracking-[0.25em] transition-all duration-300 ease-in-out group-hover:text-[#222222] whitespace-nowrap">
              RECOVER NOW
            </span>
          </motion.a>
        </div>
        ...
        <motion.div
          ...
          className="mt-4 sm:mt-6 flex flex-col items-center px-4 mb-6 sm:mb-8"
        >
          <div className="text-4xl sm:text-5xl md:text-6xl font-bold text-[#9B5DE0] mb-2">
            @
          </div>

          <div className="space-y-1.5 sm:space-y-3">
            <div className="flex flex-wrap items-center justify-center gap-1 sm:gap-4">
              <span className="text-[#9B5DE0] text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold">
                ₹1
              </span>
              <span className="inline-flex items-center gap-1 rounded-full bg-slate-900 text-slate-50 px-4 py-1 text-[10px] sm:text-[11px] font-medium tracking-[0.18em]">
                UNDAMAGED
                <span className="h-1.5 w-1.5 rounded-full bg-emerald-400" />
              </span>
              <span className="text-[#222222] text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold">
                3MB
              </span>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-4">
              ...
              <span className="inline-flex items-center gap-1 rounded-full bg-slate-900 text-slate-50 px-6 py-1 text-[10px] sm:text-[11px] font-medium tracking-[0.18em]">
                DAMAGED
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 items-stretch w-full gap-3 sm:gap-4 md:gap-8">
          ...
          >
            <div className="max-w-md w-full space-y-6 sm:space-y-8 text-center">
              <div>
                <h3 className="text-lg sm:text-2xl md:text-3xl font-medium text-slate-900 mb-2 leading-tight">
                  Data recovery is not a rocket science,
                </h3>
                <p className="text-lg sm:text-2xl md:text-3xl font-medium text-slate-900 leading-relaxed mb-6">
                  Enroll for{" "}
                  <span className="font-bold text-[#9B5DE0]">30Min</span>{" "}
                  simple process course with{" "}
                  <span className="font-bold text-[#9B5DE0]">30Mbps</span>{" "}
                  for{" "}
                  <span className="font-bold text-[#9B5DE0]">FREE</span>
                </p>
                ...
                >
                  <span className="absolute right-0 h-full w-0 bg-[#9B5DE0] transition-all duration-[400ms] ease-in-out group-hover:left-0 group-hover:right-auto group-hover:w-full" />
                  <span className="relative z-20 text-center py-3 px-6 sm:px-8 text-white text-xs sm:text-sm md:text-base font-bold tracking-[0.15em] transition-all duration-300 ease-in-out group-hover:text-[#222222] whitespace-nowrap">
                    ENROLL NOW
                  </span>
                </a>
              </div>
